...
- [ ] **Step 1: Add the metrics structs to the geometry headers**
...
- [ ] **Step 8: Run the FULL suite (nothing consumes Style yet - this pins that the refactor prep changed nothing)**
