...
- [ ] **Step 1: Extend the geometry unit tests (failing)**
...
- [ ] **Step 3: Parameterize `src/Toolbar.geom.hh`**
...
- [ ] **Step 5: The config-driven system test**
...
- [ ] **Step 6: Bless the styled-toolbar golden, then run everything**
