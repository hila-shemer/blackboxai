...
- [ ] **Step 1: Extend the frame geometry unit tests (failing)**
...
- [ ] **Step 3: Parameterize `src/Frame.hh`**
...
- [ ] **Step 6: Thread metrics through View and the hit-test**
...
- [ ] **Step 7: The Gray end-to-end golden (wildcards + PR pixel-copy)**
...
- [ ] **Step 8: Bless the new golden, run everything**
