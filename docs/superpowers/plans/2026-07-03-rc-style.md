...
- [ ] **Step 1: Write the failing tests** (verbatim lines from `reference/blackboxwm/data/styles/Gray`)
...
- [ ] **Step 4: Run to verify it passes (whole unit suite - the exact-match tests must stay green)**
