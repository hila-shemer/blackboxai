...
- [ ] **Step 1 (named POC): re-verify the sd-bus shapes against the container headers**
...
- [ ] **Step 4: Extend the mock (opt-in dbusmenu at /MenuBar)**
...
- [ ] **Step 5: Write the SniMenu client**
