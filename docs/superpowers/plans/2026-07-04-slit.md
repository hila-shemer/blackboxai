...
- [ ] **Step 1: Write the failing unit test (icon cells)**
...
- [ ] **Step 2: Write the failing system test (lifecycle)**
...
- [ ] **Step 6: Wire the Server + Toolbar accessor**
