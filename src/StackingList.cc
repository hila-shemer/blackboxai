...
// Ported VERBATIM from blackboxwm src/StackingList.cc (X tail / dump removed).
// See StackingList.hh for the port rationale.
...
namespace bbai {
  ...
  static StackEntity *const zero = nullptr;
